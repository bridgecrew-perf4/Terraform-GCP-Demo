...
7. Run vim main.tf to set the project ID from the second step to the `'project'` property and set the service account key from step 3 to the 'credentials' property. 
